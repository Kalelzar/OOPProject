...
/**
 * Describes the different tokens that {@link Hotel::Scanner Scanner}
 * recognises.
 * Some may need to be provided via {@link Hotel::CommandList CommandList}
 */
enum class TokenType {
  ...
  CHECKIN,     /**< Matches the <code>checkin</code> command in .htl files. All
                  contexts */
  CHECKOUT,    /**< Matches the <code>checkout</code> command in .htl files. All
                  contexts */
  UNAVAILABLE, /**< Matches the <code>unavailable</code> command in .htl files.
                  All contexts */

  // HTL tokens - Console only
  REPORT, /**< Matches the <code>report</code> command in .htl files. Console
             only */
  FIND,   /**< Matches the <code>find</code> command in .htl files. Console only
           */
  FIND_F, /**< Matches the <code>find!</code> command in .htl files. Console
             only */
  AVAILABILITY, /**< Matches the <code>availablility</code> command in .htl
                   files. Console only */
